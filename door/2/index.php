...
$title="Journocode Origins - The Squirrel Awakens";
$description="Enjoy the story of how and why Journocode was founded, drawn by Phil Ninh";
$share_text="Who are these crazy @journocode squirrels, anyway? Find out in today's #ddj Advent Calendar surprise!";
//=========================================================
...
<html>
  <head>
    ...
    <meta property="og:image" content="http://www.advent17.journocode.com/door/2/assets/share.png">
    <meta property="fb:app_id" content="1593595690933146" />
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@journocode">
    <meta name="twitter:title" content="<?=$title?>">
    <meta name="twitter:description" content="<?=$description?>">
    <meta name="twitter:image" content="http://www.advent17.journocode.com/door/2/assets/share.png">
    <title>
      <?=$title?>
    </title>
    <?php else : ?>
      ...
      <div class="uk-container uk-container-small">
        ...
        <article class="ac-article uk-article">
          ...
          <h1 class="ac-title uk-article-title">
            <a class="uk-link-reset" href="">Journocode Origins - The Squirrel Awakens
            </a>
          </h1>
          ...
          <p><strong>Right now, in this very second, you are (hopefully) enjoying one of the various projects made with love by Journocode. "What is Journocode", one might ask.</strong></p> <p><strong>Well, a long time ago in a galaxy far, far away....</strong></p>
          <img src="assets/journocode-origin.jpg" />

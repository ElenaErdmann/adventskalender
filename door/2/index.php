...
$title="Elepost – a crowdsourced analysis of electoral posters";
$description="xxx";
$share_text="xxx";
//=========================================================
...
<head>
  ...
  <?php if($show) : ?>
    ...
    <meta property="og:image" content="https://www.advent18.journocode.com/door/1/assets/share.png">
    <meta property="fb:app_id" content="1593595690933146" />
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@journocode">
    <meta name="twitter:title" content="<?=$title?>">
    <meta name="twitter:description" content="<?=$description?>">
    <meta name="twitter:image" content="https://www.advent18.journocode.com/door/1/assets/share.png">
    <title>
      <?=$title?>
    </title>
  <?php else : ?>
      ...
      <?php if($show) : ?>
        <article class="ac-article uk-article">
          ...
          <h1 class="ac-title uk-article-title">
            <a class="uk-link-reset" href="">Elepost – a crowdsourced analysis of electoral posters
            </a>
          </h1>
          ...
          <p><strong>Even in our digital times, printed campaign posters are still one of the most important means of electoral propaganda. For the Bavarian regional elections this fall, BR Data started a crowdsourced investigation on where and what election posters the parties had plastered on the streets of Bavaria.</strong></p>
          <div class="ac-box-container">
            <img src="assets/teaser.png" alt="">
          </div>
          <p>The elections for the regional parliament of Bavaria are one of the most important political events for our mothership Bayerischer Rundfunk, the Bavarian public broadcaster. On 14th of October the Bavarian electorate not only decided over their future parliament, their vote was also considered a benchmark for Angela Merkel’s grand coalition in Berlin. Of course, BR Data (http://br.de/data) couldn’t go without a data story covering the election campaign.
          </p>
          <p class="uk-text-lead ac-text-heading">The idea: Born in Buenos Aires
          </p>
          <p>About three months before election day, the first election posters popped up in the center of Munich and I remembered my two month visit to the Argentinean newsroom La Nación Data (https://www.lanacion.com.ar/data ) in 2017. La Nación’s data journalists had experimented many times with crowdsourced investigations, a method we at BR Data hadn’t used before. In 2014, La Nación collected pictures and GPS coordinates of giant election posters (https://www.lanacion.com.ar/1744043-quien-paga-y-cuanto-cuestan-los-carteles-anticipados-de-los-candidatos-para-2015 ) in the Buenos Aires region in a story about campaign spending. The crowdsourcing part played only a minor part in that story, but the idea for our project was born. If we collected enough pictures and location information of election posters in Bavaria, we could investigate where the parties and candidates tried to get what kind of messages across. After all, was it possible to microtarget audiences on the streets?</p>
          <p class="uk-text-lead ac-text-heading">Codename: Elepost :elephant: (elefanten-emoji einbauen!)
          </p>
          <p>The team consisted of our newest team member Maxi Richt (https://twitter.com/robbi5 ) who had just joined BR Data as a developer, along with Marco Lehner (https://twitter.com/radadmiral ), an aspiring journalism/coding student who did an internship with us over summer. Our plan was to build a prototype and collect around 100 pictures and coordinates of posters as quickly as possible. Then we wanted to evaluate whether the idea was worth pushing further. Codename: Elepost. Election Posters.</p>
          <p>IMAGE: Testing the Elepost WhatsApp bot with some pictures of our favorite Thai food: Up and running!</p>
          <p>We knew, when we wanted the project to succeed, we needed to make submitting photos and coordinates as easy as possible for our users. Maxi hacked together a quick WhatsApp integration for Airtable (http://airtable.com ), a cloud based database service with spreadsheet view for easy editing and a powerful API. After two days of coding and adding a profile pic of a cute little elephant, a first Elepost prototype was up and running on Maxi’s laptop. The photo safari began! In just one week, BR Data team members, friends and family submitted about 200 pictures from all over Munich. We challenged our team to submit more and more pictures to rise on the leaderboard. Shout out to Steffen (http://twitter.com/stekhn ), who even changed his bicycle commute to get more photos.</p>
          <p>IMAGE: Internal ranking after day one of BR Data’s election poster photo safari</p>
          <p>In the meantime, we had contacted all political parties that took part in the elections and asked for a list of their campaign posters and designs. Only one party sent us pictures of their posters, the others were not able or willing to provide us with a complete list of their poster designs, let alone locations. Although we didn’t find any direct hints for microtargeting, we knew we had an unique opportunity to get an almost complete overview of all the different election posters the parties put out on the street. So we pushed forward.</p>
          <p class="uk-text-lead ac-text-heading">Technical overview: Infrastructure and analytics
          </p>
          <p>Maxi expanded our technical infrastructure by building a Telegram bot and a web upload form capable of automatically extracting GPS coordinates from the pictures’ EXIF data. Pictures and coordinates were managed in Airtable. We pseudonymized the phone numbers and other user data for complying with the famous European data protection regulation. In order to analyze the images on a thematic level, we used Google’s cloud vision API (https://cloud.google.com/vision/ ) for optical character recognition. Marco refined his R skills by creating an analytics dashboard for the data so we could oversee the number of submitted pictures, regional distribution and most frequent topics. I was very busy managing the project, promoting the story by radio and a dedicated website and getting BR’s regional correspondents involved. </p>
          <p>IMAGE: One photo instance of the famous DIE PARTEI headscarf poster, manually categorized as poster design no. 271</p>
          <p>When we went live, the pictures started rolling in. A big chunk of my time went into manually categorizing thousands of pictures. In the future, this might be a task worth automating. Data-wise we had one table for all the pictures and their GPS coordinates, and another one for all the individual poster designs, which we manually matched and linked in Airtable.</p>
          <p class="uk-text-lead ac-text-heading">Results: 3000 pictures and some surprises
          </p>
          <p>In about three weeks our users submitted more than 3000 pictures from all regions of Bavaria. We identified more than 1000 unique poster designs in the data.</p>
          <p>IMAGE: Final map view of submitted campaign posters in Munich’s city center</p>
          <p>One of the most surprising insights was the fact that most parties in some way or another used the topic of “Heimat”, or “homeland” in their poster campaigns, enticing patriotic sentiments in their voters. Even traditionally left-wing parties like ÖDP or even the Green party used “Heimat” vibes in their posters. We also found some regional differences: some parties advertised for bigger investments in broadband infrastructure in rural areas, while focusing on rents and housing politics in the bigger cities.</p>
          <p>Read the full story in German (https://www.br.de/nachrichten/bayern/wahlplakat-analyse-wie-die-parteien-plakatieren,R5bXcoU ). </p>
          <p>Get the dataset (without the pictures) (https://web.br.de/interaktiv/wahlplakate/daten/motives_public.json ).</p>
